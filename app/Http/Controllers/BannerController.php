...
class BannerController extends Controller
{
	...
	public function getbanner($banner_id)
		...
		if(!$Banner)
		{
			...
			$response= ["error"=>array("error_code"=>$error_code,"message"=>$message),"result"=>$Banner,"success"=>$success];
	                return response()->json($response);
		}
		$success=true;	
                $BannerArr=$Banner->toArray();
	...
	{	
	    ...
	    $BannerArr=$Banner->toArray();
	    $response= ["error"=>array("error_code"=>$error_code,"message"=>$message),"result"=>$BannerArr,"success"=>$success];	
	    return response()->json($response);
	}
}
?>
